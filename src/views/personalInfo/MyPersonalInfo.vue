  ...
  <div class="wrapper">
    <div class="header">
      ...
      <img
        ...
        src="https://img1.baidu.com/it/u=4096419636,635686539&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
      />
    </div>
    <div class="list">
      ...
      <div class="list__item">
        <div class="list__item__icon iconfont">&#xe666;</div>
        <div class="list__item__test">客服帮助</div>
        <div class="list__item__arrow iconfont">&#xe8ef;</div>
      </div>
    </div>
    <div class="logout" @click="handleLogout">退出登陆</div>
  </div>
  <MyDocker :currentIndex="3"/>
</template>
...
export default {
  ...
  setup () {
    ...
    const handleLogout = () => {
      localStorage.removeItem('isMyLogin')
